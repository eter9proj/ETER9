		...
		<ul class="nav nav-pills preferences">
			<li class="dropdown pull-right">
				...
				<ul class="dropdown-menu pull-right" role="menu" aria-labelledby="profile-edit-links-dropdown">
					<li role="presentation"><a role="menuitem" href="{{$profpiclink}}" id="profile-photo_upload-link"><i class="fa ri-user-6-line" aria-hidden="true"></i>&nbsp;{{$l10n.profpic}}</a></li>
					<li role="presentation"><button role="menuitem" type="button" class="btn-link" id="profile-photo_upload-link-new" onclick="openClose('profile-photo-upload-section');"><i class="fa ri-user-6-line" aria-hidden="true"></i>&nbsp;{{$l10n.profile_photo}}</button></li>
